 ...
 *
 * This file contains the Multi-Context Protocol (MCP) agent management API controller,
 * providing RESTful endpoints for agent registration, discovery, status management, and lifecycle operations.
 */
