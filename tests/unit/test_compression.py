...
class TestCompressionDataIntegrity:
    ...
    def test_float32_array_roundtrip(self):
        ...
        # VERIFY: Exact match
        assert np.array_equal(original, restored), "Float32 data must be preserved exactly"
    ...
    def test_compression_reduces_size(self):
        ...
        assert compressed_size <= original_size, f"Compression failed: {compressed_size} > {original_size}"
    ...
    def test_metadata_completeness(self):
        ...
        required_fields = ['shape', 'dtype', 'original_size', 'compressed_size', 'compression_ratio']
