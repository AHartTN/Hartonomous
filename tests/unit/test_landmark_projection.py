...
import pytest
from src.core.spatial.landmark_projection import compute_position, compute_distance
...
class TestLandmarkSemanticPositioning:
    ...
    def test_deterministic_positioning(self):
        ...
        assert all(p == positions[0] for p in positions), "Positioning must be deterministic"
