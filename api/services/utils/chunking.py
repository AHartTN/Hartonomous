...
from typing import List, Iterator, Any, TypeVar, Optional
import numpy as np
...
def chunk_tensor_by_shape(
    ...
    if preserve_shape:
        ...
        for i in range(0, len(flat), chunk_size):
            ...
            chunks_with_info.append((chunk, i, min(i+chunk_size, len(flat)), original_shape))
