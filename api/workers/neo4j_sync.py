...
class Neo4jProvenanceWorker:
                    ...
                    try:
                        ...
                        async for notify in conn.notifies():
                            ...
                            if channel == "atom_created":
                                ...
                                asyncio.create_task(self._process_composition_created(payload))
    ...
    async def _process_composition_created(self, payload: str) -> None:
        ...
        try:
            ...
            logger.info(f"Processing composition: {parent_id} ? {child_id} (pos: {position})")
    ...
    async def _create_provenance_edge(
        ...
        try:
            ...
            logger.error(
                f"Failed to create provenance edge "
                f"{parent_id} ? {child_id}: {e}"
            )
            raise
